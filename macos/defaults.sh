...
defaults write NSGlobalDomain AppleHighlightColor -string "0.696000 0.843000 0.998000"
...
# Set dev workspace as the default location for new Finder windows
...
# Stop hitting the Backspace key to go to the previous page in history
